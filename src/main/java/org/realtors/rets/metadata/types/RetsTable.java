...
public class RetsTable extends MetadataObject {
	...
	private static final AttrType<String> sDataTypes = new AttrEnum(DATATYPES);
	private static final String[] INTERPRETATIONS = "Number,Currency,Lookup,LookupMulti,LookupBitstring,LookupBitmask".split(",");
	private static final AttrType<String> sInterpretations = new AttrEnum(INTERPRETATIONS);
	private static final String[] ALIGNMENTS = "Left,Right,Center,Justify".split(",");
	private static final AttrType<String> sAlignments = new AttrEnum(ALIGNMENTS);
	private static final String[] UNITSS = "Feet,Meters,SqFt,SqMeters,Acres,Hectares".split(",");
	private static final AttrType<String> sUnits = new AttrEnum(UNITSS);

	public RetsTable() {
		this(DEFAULT_PARSING);
	}

	public RetsTable(boolean strictParsing) {
		super(strictParsing);
	}
